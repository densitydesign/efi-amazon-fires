  ...
  return (
    ...
    >
      ...
      <div className="container-fluid bg-primary ">
        <div className="row ">
          <div className="col-10 offset-1">
            <h1 className=" serif fw-bolder pt-5">Methodologies</h1>
          </div>
        </div>
        <div className="row py-5">
          <div className="col-8 offset-1">
            <p>
              We employed “quanti-qualitative” social media analysis, specifically Twitter image and content analysis with digital methods (Rogers, 2013, 2019; Caliandro & Gandini, 2016) and cross-platform image analysis with visual methods (Colombo, 2019; Rose, 2016; Rogers, 2017, Niederer, 2018, 2019; Niederer & Colombo, 2019). Detailed methodological elaboration can be found in the Out of the Flames full report [LINK].
              {' '}
            </p>
            ...
            <p>
              By taking an empiricist and participatory style of inquiry, issue experts with knowledge and expertise about the subject matter were invited to participate in collaborative interpretation of network maps and visualisations.
            </p>
